            ...
            <div className="grid lg:grid-cols-3 gap-8">
                  ...
                  <article key={it.productId} className="bg-card border border-border rounded-2xl p-4 sm:p-5 shadow-soft flex gap-4 items-center">
                    ...
                    <div className="flex flex-col items-end gap-2">
                      <div className="flex items-center border border-border rounded-lg">
                        ...
                        <button onClick={() => setQuantity(it.productId, it.quantity + 1)} className="h-8 w-8 flex items-center justify-center hover:bg-muted"><Plus className="h-3.5 w-3.5" /></button>
                      </div>
              ...
              <aside className="lg:sticky lg:top-32 h-fit bg-card border border-border rounded-2xl p-6 shadow-elegant">
                ...
                <div className="mt-5 space-y-3 text-sm">
                  ...
                  {shipping > 0 && <p className="text-xs text-muted-foreground">Te faltan <span className="font-semibold text-secondary">{formatCOP(260000 - subtotal)}</span> para envío gratis.</p>}
